...
func _ready():
    ...
    $DraggableWindow/MarginContainer/MarginContainer/VBoxContainer/MarginContainer/VBoxContainer/NameLabel.text = combo.bonus_name
    $DraggableWindow/MarginContainer/MarginContainer/VBoxContainer/MarginContainer/VBoxContainer/DescriptionLabel.text = combo.text
    ...
    $DraggableWindow/MarginContainer/MarginContainer/VBoxContainer/MarginContainer/VBoxContainer/ComboTextureRect.texture = load("res://images/bonuses/%s.png" % [combo.id.to_lower()])
